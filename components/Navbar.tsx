...
/* ── Nav links — disesuaikan dengan section yang ada ───── */
const NAV_LINKS = [
...
function NavSkeleton() {
    return (
        <div style={{
            ...
            <div style={{ marginLeft: "auto", width: 40, height: 40, borderRadius: 10, background: "linear-gradient(90deg,#ede9e3 25%,#e3dfd8 50%,#ede9e3 75%)", backgroundSize: "200% 100%", animation: "nav-shimmer 1.6s ease-in-out infinite" }} className="nav-sk-burger" />
            <style>{`
        @keyframes nav-shimmer { 0%{background-position:200% 0} 100%{background-position:-200% 0} }
        @media (max-width: 767px) { .nav-sk-links{display:none!important} .nav-sk-cta{display:none!important} }
        @media (min-width: 768px) { .nav-sk-burger{display:none!important} }
      `}</style>
        </div>
    );
}
        ...
        <>
            ...
            >
                <div style={{
                    ...
                    {/* Logo */}
                    <Link href="/" style={{ display: "flex", alignItems: "center", flexShrink: 0, zIndex: 10, textDecoration: "none" }}>
                        <motion.div
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 12, zIndex: 10, flexShrink: 0 }}>
                        ...
                        <motion.div whileHover={{ y: -1 }} whileTap={{ scale: 0.97 }} className="nav-cta-desktop">
                            ...
                            >
                                Konsultasi Acara Anda <ArrowRight size={13} strokeWidth={2.5} />
                            </Link>
                        </motion.div>
                        ...
                        <motion.button
                            ...
                            style={{
                                ...
                                background: "white",
                                cursor: "pointer", color: "#18181A", flexShrink: 0,
                            }}
                        >
                            <AnimatePresence mode="wait" initial={false}>
                                {mobileOpen
                                    ...
                                    : <motion.span key="m" initial={{ rotate: 90, opacity: 0 }} animate={{ rotate: 0, opacity: 1 }} exit={{ rotate: -90, opacity: 0 }} transition={{ duration: 0.15 }} style={{ display: "flex" }}><Menu size={18} /></motion.span>
                                }
                            </AnimatePresence>
                        </motion.button>
                    </div>
                ...
                {mobileOpen && (
                    <>
                        ...
                        <motion.div
                            ...
                            style={{
                                position: "fixed",
                                top: 68, left: 0, right: 0, zIndex: 200,
                        ...
                        >
                            {/* Color stripe */}
                            <div style={{ height: 3, background: "linear-gradient(90deg,#00A8B5,#6B32A8,#C4006E)" }} />
                            ...
                            <div style={{ padding: "12px 16px 20px", display: "flex", flexDirection: "column", gap: 2 }}>
                                ...
                                >
                                    ...
                                    >
                                        Konsultasi Acara Anda <ArrowRight size={14} strokeWidth={2.5} />
                                    </Link>
                                </motion.div>
                            </div>
                        </motion.div>
