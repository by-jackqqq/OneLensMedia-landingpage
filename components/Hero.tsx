...
// Ganti dengan path file MP4 kamu, contoh: "/videos/demo.mp4"
const VIDEO_SRC = "/videos/demo.mp4";

export default function Hero() {
    return (
        <>
            <section style={{ position: "relative", height: "100vh", minHeight: 600, display: "flex", alignItems: "center", background: "#FAFAF8", overflow: "hidden" }}>
                ...
                {/* Grid */}
                <div style={{ position: "relative", zIndex: 10, width: "100%", maxWidth: 1280, margin: "0 auto", padding: "80px 40px 40px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48, alignItems: "center", height: "100%" }} className="hero-grid-responsive">

                    {/* ── LEFT ─────────────────────────────────────────────────────── */}
                    <div style={{ display: "flex", flexDirection: "column" }}>

                        {/* H1 */}
                        <motion.h1 {...fu(0.1)} style={{ fontFamily: "var(--font-montserrat)", fontWeight: 700, fontSize: "clamp(2.2rem, 4.2vw, 4rem)", lineHeight: 1.1, letterSpacing: "-0.5px", color: "#18181A", marginBottom: 18 }}>
                            Satu Lensa,<br />
                        ...
                        {/* Description */}
                        <motion.p {...fu(0.2)} style={{ color: "#6B6B70", fontSize: "0.95rem", lineHeight: 1.7, maxWidth: 420, marginBottom: 28 }}>
                        ...
                        {/* Buttons */}
                        <motion.div {...fu(0.3)} style={{ display: "flex", flexWrap: "wrap", gap: 12, marginBottom: 32 }}>
                        ...
                        {/* Stats */}
                        <motion.div {...fu(0.4)} style={{ display: "flex", alignItems: "center" }}>
                            {STATS.map((s, i) => (
                    ...
                    >
                        ...
                        {/* Main card — Portrait video */}
                        <div style={{ background: "#FFFFFF", border: "1px solid #E2E0DB", borderRadius: 20, overflow: "hidden", boxShadow: "0 8px 40px rgba(0,0,0,0.08)", width: "100%", maxWidth: 300 }}>

                            {/* Portrait video — tinggi dinamis agar muat di layar */}
                            <div style={{ position: "relative", height: "min(62vh, 500px)", background: "#000", borderRadius: "20px 20px 0 0", overflow: "hidden" }}>
                                <video
                                    src={VIDEO_SRC}
                                    autoPlay
                                    loop
                                ...
                                <div style={{ position: "absolute", top: 12, left: 12, display: "flex", alignItems: "center", gap: 6, background: "rgba(0,0,0,0.45)", border: "1px solid rgba(255,255,255,0.15)", borderRadius: 100, padding: "5px 12px", backdropFilter: "blur(8px)", zIndex: 10, pointerEvents: "none" }}>
